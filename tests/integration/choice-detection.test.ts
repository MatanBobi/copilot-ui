...
async function main() {
  ...
  async function detectChoices(client: InstanceType<typeof CopilotClient>, message: string): Promise<{ isChoice: boolean; options?: { id: string; label: string; description?: string }[] }> {
    try {
