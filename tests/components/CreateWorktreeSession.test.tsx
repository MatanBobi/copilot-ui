...
describe('CreateWorktreeSession', () => {
  ...
  it('calls fetchAzureDevOpsWorkItem for dev.azure.com URLs', async () => {
    ...
    const input = screen.getByPlaceholderText(/GitHub or Azure DevOps URL/i)
    fireEvent.change(input, { target: { value: 'https://dev.azure.com/myorg/myproject/_workitems/edit/456' } })
    ...
    await waitFor(() => {
      expect(mockFetchAzureDevOpsWorkItem).toHaveBeenCalledWith('https://dev.azure.com/myorg/myproject/_workitems/edit/456')
    })
  })
  ...
  it('calls fetchAzureDevOpsWorkItem for visualstudio.com URLs', async () => {
    ...
    const input = screen.getByPlaceholderText(/GitHub or Azure DevOps URL/i)
    fireEvent.change(input, { target: { value: 'https://msazure.visualstudio.com/One/_workitems/edit/789' } })
    ...
    await waitFor(() => {
      expect(mockFetchAzureDevOpsWorkItem).toHaveBeenCalledWith('https://msazure.visualstudio.com/One/_workitems/edit/789')
    })
  })
  ...
  it('displays Azure DevOps authentication error with instructions', async () => {
    mockFetchAzureDevOpsWorkItem.mockRejectedValue(new Error(
    ...
    // Find the input and enter an Azure DevOps URL
    const input = screen.getByPlaceholderText(/GitHub or Azure DevOps URL/i)
    fireEvent.change(input, { target: { value: 'https://msazure.visualstudio.com/One/_workitems/edit/12345' } })
